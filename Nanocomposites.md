...
# Fabrication
One of the primary challenges with fabricating nanocomposites is overcoming nanoparticle aggregation. Essentially, this describes the joining of two or more nanoparticles into a larger cluster that has a greater propensity for reabsorbing or scattering photon emissions. Aggregation is thus detrimental to transmittance and ultimately reduces technical light yield. The key strategy for preventing aggregation is to encapsulate each nanoparticle in specifically coated [surfactants](Surfactants.md) (a.k.a ligands) to act as a buffer between the metallic nanoparticles. For ideal dispersion in an emulsion, the surfactants should be bifunctional, with one functional group binding strongly to the nanoparticle, and the other being soluble in the solvent of choice. In the case of embedding nanoparticles in a polymer matrix, the ligand should have a functional group that allows it to copolymerize with the polymer chains. If the nanoparticles cannot be synthesized in a suspension of the plastic monomer, then whatever surfactants are used during synthesis will have to be (at least partially) exchanged before polymerization. This means the metallic-binding functional groups should not bind too strongly to the nanoparticles, or at least that they should be removable, or exchangeable. 